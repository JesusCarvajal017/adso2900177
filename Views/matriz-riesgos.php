  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12 ">
            <h2 class="text-center mb-4">Matriz de Gestión de Riesgos ADSO-2900177</h2>

            <div class="container-btn-download mb-3">
              <a href="../assets/Documents/Mitigacion de Riesgos.xlsx" download="Mitigacion de Riesgos.xlsx">
