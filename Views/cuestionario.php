  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <!-- Grupo01 -->
            <li class="sidebar-item">
              <a class="sidebar-link" href="Grupos/card-01.php" aria-expanded="false">
                <span>
            ...
            <!-- Grupo02 -->
            <li class="sidebar-item">
              <a class="sidebar-link" href="Grupos/card-02.php" aria-expanded="false">
                <span>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-users-group">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    <path d="M10 13a2 2 0 1 0 4 0a2 2 0 0 0 -4 0" />
            ...
            <!-- Grupo03 -->
            <li class="sidebar-item">
              <a class="sidebar-link" href="Grupos/card-03.php" aria-expanded="false">
                <span>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-users-group">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    <path d="M10 13a2 2 0 1 0 4 0a2 2 0 0 0 -4 0" />
            ...
            <!-- Grupo04 -->
            <li class="sidebar-item">
              <a class="sidebar-link" href="Grupos/card-04.php" aria-expanded="false">
                <span>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-users-group">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    <path d="M10 13a2 2 0 1 0 4 0a2 2 0 0 0 -4 0" />
            ...
            <!-- Grupo05 -->
            <li class="sidebar-item">
              <a class="sidebar-link" href="Grupos/card-05.php" aria-expanded="false">
                <span>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-users-group">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    <path d="M10 13a2 2 0 1 0 4 0a2 2 0 0 0 -4 0" />
            ...
            <!-- Grupo06 -->
            <li class="sidebar-item">
              <a class="sidebar-link" href="Grupos/card-06.php" aria-expanded="false">
                <span>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-users-group">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    <path d="M10 13a2 2 0 1 0 4 0a2 2 0 0 0 -4 0" />
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="matriz-riesgos.php" aria-expanded="false">
                <span>
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12 ">
            <h2 class="text-center mb-4">Cuestionario General Clasificado por Temas</h2>

            <div class="container-btn-excel">
              <a href="../assets/Documents/Focus.xlsm" download="Focus.xlsm">
                <img class="icono-excel pulse" src="../assets/images/Icono Excel.png" alt="">
              </a>
            </div>
          </div>
        </div>
    ...
    <script src="../assets/js/matrizRiesgos.js"></script>
